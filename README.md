# Dynamic Customer Satisfaction Modeling via Time-Aware Aspect Sentiment Alignment (T-AASA)
...
This repository contains the official implementation of **T-AASA (Time-Aware Aspect Sentiment Alignment)** integrated with the **SDMAE (Syntax-Denoising Masked Autoencoder)** aspect sentiment analysis baseline.
